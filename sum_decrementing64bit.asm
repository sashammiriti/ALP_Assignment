...
print_rbx:
    ; Standard register saving (push/pop) is omitted for simplicity in this context,
    ; but in professional code, these registers would be saved/restored.
    push rax
    push rbx
    push rdi
    mov rax, rbx
